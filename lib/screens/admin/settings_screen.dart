    ...
    switch (option) {
      case 'profileSetting':
        return ProfileSettings(
          onProfileUpdated: (String name, String branch, String year) {},
        );
      case 'changePassword':
...
class ProfileSettings extends StatefulWidget {
  final void Function(String name, String branch, String year) onProfileUpdated;
...
class _ProfileSettingsScreenState extends State<ProfileSettings> {
  ...
  TextEditingController yearController =
      TextEditingController(); // Added year field
  ...
  final String apiUrl = '${AppConfig.baseUrl}/api/profile-settings'; // Update the API URL
  ...
  void dispose() {
    ...
    feeRecHeaderController.dispose();
    branchAddressController.dispose();
    taxNoController.dispose();
    feeFooterController.dispose();
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildTextField('Year', yearController, false), // Added year field
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  Future<void> _changePassword() async {
    if (_formKey.currentState!.validate()) {
      ...
      final email = 'user_email@example.com'; // Replace with actual email
      final token = 'user_jwt_token'; // Replace with actual token
